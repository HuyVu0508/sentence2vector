...
# Assigning values for all unassigned FLAGs values
FLAGS.input_files = "../../UMBC corpus/webbase_all_sentences_tokenized/words/*"
FLAGS.vocab_file = "../dictionaries/Glove/glove.6B.300d.txt"
FLAGS.output_dir = "../../UMBC corpus/webbase_all_sentences_tokenized/TFRecords_words"
FLAGS.case_sensitive = False    
#FLAGS.input_files = "../../UMBC corpus/webbase_all_sentences_tokenized/POSs/*"
#FLAGS.vocab_file = ""
#FLAGS.output_dir = "../../UMBC corpus/webbase_all_sentences_tokenized/TFRecords_POSs"
#FLAGS.case_sensitive = True    
FLAGS.train_output_shards = 100
FLAGS.validation_output_shards = 1
FLAGS.num_validation_sentences = 50000
FLAGS.num_words = 50001
...
#    vocab[words[w_index]] = w_id + 1  # 0: <unk>
  # POS  
  for w_id, w_index in enumerate(sorted_indices):
    vocab[words[w_index]] = w_id + 1  # 0: <unk>    

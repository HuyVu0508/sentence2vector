...
tf.flags.DEFINE_string("eval_task", "MSRP", "Name of the evaluation task to run. Available tasks: MR, CR, SUBJ, MPQA, SICK, MSRP, TREC.")
...
####
FLAGS.model_version = 0 # Determining running model: 0 - original model, 1 - improved model
####
FLAGS.eval_task = "TREC"
FLAGS.data_dir = "evaluations/TREC"
FLAGS.uniform_init_scale = 0.1
FLAGS.batch_size = 100
FLAGS.use_norm = False
FLAGS.sequence_length = 30
FLAGS.model_config = "../model_configs/BS400-W300-S1000-Glove-UMBC-bidir/eval_noexp.json"
FLAGS.results_path = ""
